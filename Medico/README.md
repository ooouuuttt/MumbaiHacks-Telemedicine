...
> ⚠ All references to specific AI providers have been removed.
...
### 5️⃣ Run AI Flow Watcher (if applicable)

```bash
npm run genkit:watch
```

AI flow server runs at:
...
| `npm run genkit:watch` | Watch AI agent flows     |
